 ...
 */
public abstract class MultiLevelCollectorTemp<
    ...
    implements Serializable
{
    ...
    protected UNIT_COLLECTOR allReadCollector;
    ...
    protected List<Distributor> outputOrderedDistributors;
     ...
     * @param <HISTOGRAM_KEY>
     * @param <ARGTYPE>
     * @param <UNIT_COLLECTOR>
     */
    public MultiLevelCollectorTemp<METRIC_TYPE, HISTOGRAM_KEY, ARGTYPE, UNIT_COLLECTOR> combine(
            MultiLevelCollectorTemp<METRIC_TYPE, HISTOGRAM_KEY, ARGTYPE, UNIT_COLLECTOR> c1,
            MultiLevelCollectorTemp<METRIC_TYPE, HISTOGRAM_KEY, ARGTYPE, UNIT_COLLECTOR> c2)
    {
        // TODO: this mutates c1!
        //c1.allReadCollector = combineUnit(c1.allReadCollector, c2.allReadCollector);

        // TODO assert that these lists are the same size/shape
        for (int i = 0; i < c1.outputOrderedDistributors.size(); i++) {
            c1.outputOrderedDistributors.get(i).combine(c2.outputOrderedDistributors.get(i), this::combineUnit);
        }
     ...
     */
    private abstract class Distributor implements Serializable {
        private static final long serialVersionUID = 1L;

        //A Map mapping the key for a specific record (as determined by getKey) to the appropriate collector
        private final Map<String, UNIT_COLLECTOR> collectors;
        ...
        public void combine(Distributor source, BiFunction<UNIT_COLLECTOR, UNIT_COLLECTOR, UNIT_COLLECTOR> reMap) {
     ...
     */
    private class AllReadsDistributor extends Distributor implements Serializable {
    ...
    private class SampleDistributor extends Distributor implements Serializable {
        private static final long serialVersionUID = 1L;
    ...
    private class LibraryDistributor extends Distributor implements Serializable  {
        private static final long serialVersionUID = 1L;
    ...
    private class ReadGroupCollector extends Distributor implements Serializable {
        private static final long serialVersionUID = 1L;
