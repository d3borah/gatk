...
public final class Sample {
    ...
    public Sample(final String id, final Collection<String> readGroups) {
        ...
        Utils.nonNull(readGroups);
        Utils.containsNoNull(readGroups, "the input read-groups collection contains null values");

        final Set<String> readGroupSet = new LinkedHashSet<>(readGroups);
        Utils.validateArg(readGroupSet.size() == readGroups.size(), "readGroups contains duplicates");
