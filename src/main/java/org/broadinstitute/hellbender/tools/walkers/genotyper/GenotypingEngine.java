...
public abstract class GenotypingEngine<Config extends StandardCallerArgumentCollection> {
    ...
    protected VariantCallContext calculateGenotypes(final FeatureContext features,
        ...
        //TODO: this is really ugly but AFCalculator is going to be scrapped soon
        final boolean isDiploid = afCalculator.getClass() != GeneralPloidyExactAFCalculator.class;

        final VariantContext reducedVC = AlleleSubsettingUtils.reduceNumberOfAlleles(vc, defaultPloidy, maxAltAlleles, isDiploid, GenotypeAssignmentMethod.SET_TO_NO_CALL);
        ...
        final GenotypesContext genotypes = AlleleSubsettingUtils.subsetAlleles(vc, defaultPloidy, isDiploid,
                outputAlleles, GenotypeAssignmentMethod.USE_PLS_TO_ASSIGN);
