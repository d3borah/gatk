...
public final class NDNCigarReadTransformer implements ReadTransformer {
    ...
    public GATKRead apply(final GATKRead read) {
        ...
        Utils.nonNull(originalCigar.isValid(read.getName(), -1), "try to transform a read with non-valid cigar string: readName: "+read.getName()+" Cigar String: "+originalCigar);
