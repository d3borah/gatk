...
//class HistBin<K> implements Serializable {
//    private static final long serialVersionUID = 1L;
//}
//
//@DefaultSerializer(value= FieldSerializer.class)
//
//final class MyHistogram<K extends Comparable> extends TreeMap<K, HistBin<K>> implements Serializable {
//    private static final long serialVersionUID = 1L;
//
//   public  String fooBar = null;
//}

public final class CollectInsertSizeMetricsSparkIntegrationTestTemp extends CommandLineProgramTest {
    ...
    public String getTestedClassName() {
        return CollectInsertSizeMetricsSparkTemp.class.getSimpleName();
    }

    @Test
    public void testSerializerHistogramMap() {
...
//        GATKHistogram<Integer> fooHist = new GATKHistogram<>();
//        GATKHistogram<Integer> roundHist = SparkTestUtils.roundTripInKryo(fooHist, GATKHistogram.class, conf);
//        Assert.assertEquals(fooHist, roundHist);

        PerUnitInsertSizeMetricsCollector pu = new PerUnitInsertSizeMetricsCollector(
                "sample",
                "library",
                "readGroup",
                0.1,
        ...
        final PerUnitInsertSizeMetricsCollector roundTrippedPU = SparkTestUtils.roundTripInKryo(pu, PerUnitInsertSizeMetricsCollector.class, conf);
        Assert.assertEquals(pu, roundTrippedPU);
    }
...
//                {"/home/chris/projects/hellbender/src/test/resources/large/CEUTrio.HiSeq.WGS.b37.NA12878.20.21.bam",
//                        "/home/chris/projects/hellbender/src/test/resources/large/human_g1k_v37.20.21.fasta"}
        };
    }
...
//        final File textOut = new File("~/sparkAggTest", ".txt");
//        final File pdfOut = new File("~/sparktAggTest", ".pdf");
